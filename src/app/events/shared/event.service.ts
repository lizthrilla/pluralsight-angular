...
export class EventService {
  ...
  // @Injectable only necessary if you have a constructor that is injecting a dependency.  But since you never know if a service will end up having a dependency it's recommended to just add it from the start as it doesn't hurt anything
  // example of injecting a dependency constructor(private http:Http) {}
  getEvents = () => {
    return EVENTS;
  }
}
